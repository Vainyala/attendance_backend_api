...
export async function createProject(connection,data) {
  const {
    project_id, org_short_name, project_name, project_site, client_name, client_location,
...
export async function updateProject(project_id, data) {
  const {
    org_short_name = null, project_name = null, project_site= null, client_name= null, client_location= null,
  ...
  const [result] = await mariadb.execute(
    `UPDATE project_master SET
      org_short_name = ?, project_name = ?, project_site = ?, client_name = ?, client_location = ?,
...
export async function updateProjectPartially(project_id, data) {
  ...
  const [result] = await mariadb.execute(
    `UPDATE project_master SET
      org_short_name COALESCE(?, org_short_name), project_name = COALESCE(?, project_name), project_site = COALESCE(?, project_site), 
